...
# Start MAVProxy 1
/home/hcprajwal/venv-ardupilot/bin/mavproxy.py --retries 5 --master tcp:127.0.0.1:5760 --sitl 127.0.0.1:5501 --out 127.0.0.1:14590 &
...
# Start MAVProxy 2
/home/hcprajwal/venv-ardupilot/bin/mavproxy.py --retries 5 --master tcp:127.0.0.1:5770 --sitl 127.0.0.1:5511 --out 127.0.0.1:14591 &
...
# Start MAVProxy 3
/home/hcprajwal/venv-ardupilot/bin/mavproxy.py --retries 5 --master tcp:127.0.0.1:5780 --sitl 127.0.0.1:5521 --out 127.0.0.1:14592 &
